...
Variables carry colours, radii and fonts. The rest of the Tecton look of the generated components comes from the `base-tecton` **style**, a shadcn preset built exactly like Vega or Nova (see [CLI & updates](/docs/cli)), not from overrides of the generated files:
