...
upstream: apps/v4/content/docs/components/base/carousel.mdx
---
...
```tsx lineNumbers /-ml-2/ /pl-2/ /md:-ml-4/ /md:pl-4/
<Carousel>
...
```tsx lineNumbers /vertical | horizontal/
