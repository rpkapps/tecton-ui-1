...
- **Dark first.** The Tecton design system is dark-only today; the dark theme is exact and the light theme is derived from it (and marked approximated).
...
| [Theming](/docs/theming) | The token mapping, light/dark, adding tokens, known deviations |
