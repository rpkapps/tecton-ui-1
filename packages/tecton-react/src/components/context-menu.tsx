  ...
  "group/context-menu-item relative flex cursor-default items-center outline-hidden select-none data-disabled:pointer-events-none data-disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:shrink-0",
  {
    variants: {
      selectionMode: {
        ...
        single:
          "gap-2 rounded-sm py-1.5 pr-8 pl-2 text-sm focus:bg-accent focus:text-accent-foreground data-inset:pl-8 [&_svg:not([class*='size-'])]:size-4",
        multiple:
          "gap-2 rounded-sm py-1.5 pr-8 pl-2 text-sm focus:bg-accent focus:text-accent-foreground data-inset:pl-8 [&_svg:not([class*='size-'])]:size-4",
      },
    },
...
function ContextMenuSubContent({
  ...
  return (
    <ContextMenu
      ...
      className={cn("w-auto min-w-32 rounded-md border bg-popover p-1 text-popover-foreground shadow-lg duration-100", className )}
      placement={placement}
      crossOffset={crossOffset}
      offset={offset}
      {...props}
