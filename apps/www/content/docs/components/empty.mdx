...
upstream: apps/v4/content/docs/components/base/empty.mdx
---
...
<Dont severity="HIGH" title="Hand-building the empty state from divs">
...
<Dont severity="MEDIUM" title="An icon without its EmptyMedia tile">
