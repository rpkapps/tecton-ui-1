export default function TypographyDemo() {
  return (
    <div className="flex w-full max-w-xl flex-col gap-5">
      <p className="text-5xl leading-tight font-medium tracking-tight">
        Display 1
      </p>
      ...
      <p className="text-sm">
        Medium — Body copy for product UI. Figtree is the interface typeface; it
        keeps dense forms and tables legible at 14px.
      </p>
      <p className="text-xs text-muted-foreground">
        Small — helper and metadata text
      </p>
