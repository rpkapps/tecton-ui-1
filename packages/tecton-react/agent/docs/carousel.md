...
# Carousel — @tecton/react/components/carousel
...
- sections the reader chooses by name → `Tabs` (tecton docs tabs)
- a row of cards the reader scrolls freely → `ScrollArea` (tecton docs scroll-area)
