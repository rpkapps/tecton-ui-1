...
![Sidebar Structure](/images/sidebar-structure-dark.png)
...
```tsx showLineNumbers title="@tecton/react/components/sidebar.tsx"
...
![Sidebar Menu](/images/sidebar-menu-dark.png)
...
The sidebar follows the reading direction set with the [Direction](/docs/components/direction.md) provider; no extra configuration is needed.
