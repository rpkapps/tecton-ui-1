...
upstream: apps/v4/content/docs/components/base/spinner.mdx
---
...
You can replace the default spinner icon with any other icon by defining your own `Spinner` with it.

<ComponentPreview name="spinner-custom" />

```tsx lineNumbers title="components/spinner.tsx"
import { cn } from "cn"
