    ...
    <TagPrimitive
      ...
      className={composeRenderProps(className, (className) =>
        cn(
          ...
          "cursor-pointer transition-colors outline-none select-none data-focus-visible:border-ring data-focus-visible:ring-2 data-focus-visible:ring-ring data-disabled:pointer-events-none data-disabled:opacity-50",
...
function ChipRemove({
  ...
  return (
    <ButtonPrimitive
      ...
      className={composeRenderProps(className, (className) =>
        cn(
          "ms-0.5 -me-1 inline-flex size-4 shrink-0 items-center justify-center rounded-full opacity-70 outline-none hover:opacity-100 data-focus-visible:ring-2 data-focus-visible:ring-ring [&_svg]:size-3",
          className
        )
      )}
      {...props}
