...
upstream: apps/v4/content/docs/components/base/chart.mdx
---
...
```tsx lineNumbers /ChartContainer/ /ChartTooltipContent/
...
```tsx title="components/example-chart.tsx" lineNumbers
const chartData = [
