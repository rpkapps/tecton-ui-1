...
The shimmer composes with any component that renders text. A common pattern is a [Marker](/docs/components/marker.md) showing a live status while the assistant is working:
