...
upstream: apps/v4/content/docs/components/aria/data-table.mdx
---
...
```tsx lineNumbers title="app/payments/columns.tsx" {4,6-13,17-46}
"use client"
...
```tsx lineNumbers title="app/payments/data-table.tsx" {3,8,15,21-24,31-46}
"use client"
...
```tsx lineNumbers title="app/payments/columns.tsx" {4,10-17}
"use client"
...
```tsx lineNumbers title="app/payments/data-table.tsx" {8,14-19,29-30,38,42,57-99}
"use client"
...
```tsx lineNumbers title="app/payments/columns.tsx" {6,9-15}
"use client"
...
```tsx lineNumbers title="app/payments/data-table.tsx" {11,20,25,33-43}
export function DataTable<TData extends RowData>({
  columns,
  data,
}: DataTableProps<TData>) {
