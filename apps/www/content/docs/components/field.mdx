...
upstream: apps/v4/content/docs/components/base/field.mdx
---
...
See the [Form](/docs/forms) documentation for building forms with the `Field` component and [React Hook Form](https://ui.shadcn.com/docs/forms/react-hook-form), [Tanstack Form](/docs/forms/tanstack-form), or [Formisch](https://ui.shadcn.com/docs/forms/formisch).
...
- a label for a control that stands on its own, outside a field: use [Label](/docs/components/label)
- the single-line text control itself: use [Input](/docs/components/input)
- form state, validation and typed error objects: use [TanStack Form](/docs/forms/tanstack-form)
...
<Dont severity="CRITICAL" title="Announcing the error with a red paragraph">
...
<Dont severity="HIGH" title="Marking the control invalid but not the field">
...
<Dont severity="HIGH" title="Reaching for FieldTitle where a label belongs">
