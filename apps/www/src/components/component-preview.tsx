    ...
    >
      ...
      {!hideCode && (
        <div
          ...
          className="relative overflow-hidden **:data-[slot=copy-button]:right-4 **:data-[slot=copy-button]:hidden data-[mobile-code-visible=true]:**:data-[slot=copy-button]:flex [&_[data-code-block]]:m-0! [&_[data-code-block]]:rounded-t-none [&_[data-code-block]]:border-t [&_pre]:max-h-72"
        >
          {isMobileCodeVisible ? (
            source
          ) : (
