    ...
    <div className="container-wrapper flex flex-1 flex-col gap-10 px-6 py-8 md:py-10">
      <PageHeader>
        <PageHeaderContent>
          ...
          <PageHeaderDescription>
            The Tecton theme is a set of values for the shadcn CSS variables.
            Switch the mode, try a different radius scale and copy the generated
            CSS.
          </PageHeaderDescription>
        </PageHeaderContent>
      </PageHeader>
        ...
        <div className="flex flex-col gap-6">
          ...
          <div className="flex flex-col gap-2">
            ...
            <p className="text-xs text-muted-foreground">
              Tecton pins <code>--radius-sm</code>…<code>--radius-2xl</code>{" "}
              explicitly, so only utilities based on
          ...
          <Alert variant="info" appearance="outline">
            ...
            <AlertDescription>
              Every shadcn variable references a token from the Tecton CSS
      ...
      <section className="flex flex-col gap-4">
        <div className="flex flex-col gap-1">
          ...
          <p className="text-sm text-muted-foreground">
            The Tecton colour ramps that replace Tailwind&apos;s stock palette:
            fifteen families, twenty-three contrast steps each, switching value
            with the mode. The semantic variables above are picks from these
            ramps.
          </p>
        </div>
        ...
        <Tabs defaultValue="css" className="gap-3">
          ...
          <TabsContent value="css">
            <CodeBlock
              code={themeCss}
              lang="css"
              title="@tecton/react/styles/tecton-theme.css"
