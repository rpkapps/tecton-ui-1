// Synced from shadcn/ui (apps/v4/examples/aria/marker-icon.tsx) by scripts/sync-upstream-docs.mts — do not edit.
import { AccountTreeIcon, LibraryAddCheckIcon, SearchIcon } from "@tecton/react/icons"
