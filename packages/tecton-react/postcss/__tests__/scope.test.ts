...
function run(css: string, options: Parameters<typeof scopeTecton>[0]) {
  return postcss([scopeTecton(options)]).process(css, { from: undefined }).css
}
...
describe("scopeTecton", () => {
  ...
  it("leaves Tailwind's `:root, :host` defaults unscoped inside their layer", () => {
  ...
  it("recurses into the `@supports` of `@layer properties` instead of wrapping it", () => {
