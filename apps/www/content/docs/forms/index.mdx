---
title: Forms
description: Build forms with the Field components and a headless form library.
---
...
<div className="mt-8 grid gap-4 sm:grid-cols-2 sm:gap-6">
  ...
  <LinkedCard href="https://ui.shadcn.com/docs/forms/react-hook-form" target="_blank" rel="noreferrer" className="border border-dashed bg-transparent">
    <p className="mt-2 font-medium">React Hook Form</p>
    <p className="mt-1 text-xs text-muted-foreground">Upstream guide</p>
  </LinkedCard>
</div>
...
The upstream React Hook Form guide applies as well, with the components imported from `@tecton/react`.
